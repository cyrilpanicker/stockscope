...
export const logProcessedInfo = ({id,stock,count,lastDate,latestPrice,error,ss_url,yql_url,nse_url}) => {
    processLogger.info(id+' | '+stock+' | '+count+' | '+lastDate+' | '+latestPrice+' | '+error+' | \n'+ss_url+' | \n'+nse_url+' | \n'+yql_url);
};